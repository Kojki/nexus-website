...
const faqs = [
  {
    ...
    a: "はい、大歓迎です！Nexusは「やりたいことを探すための観察の場」でもあります。まずは他のメンバーの活動や議論を見ているだけでも全く問題ありません。興味を持った話題にだけ反応するというスタイルでも十分です。",
  },
  {
    q: "参加費はかかりますか？",
    a: "完全無料です。意欲ある学生が誰でも等しく参加できる場を目指しているため、費用は一切いただきません。",
  },
  {
    q: "どんな学生が参加していますか？",
    a: "テクノロジー・ビジネス・デザイン・研究など、様々な分野に興味を持つ高校生・大学生が参加しています。「専門がある」「専門を探している」どちらの学生も交わっています。",
  },
  {
  ...
  {
    q: "英語が話せなくても大丈夫ですか？",
    a: "はい、日本語での参加が基本です。現在は日本全国の学生を対象にしており、コミュニケーションは基本的に日本語で行われています。",
  },
];
