        ...
        <div className="guidelines-list">
          {guidelines.map((item, index) => (
            ...
            >
              ...
              <p>{item.body}</p>
              <p className="guideline-sub">{item.sub}</p>
            </div>
          ))}
        </div>
