        ...
        >
          ...
          <a
            ...
            onMouseEnter={e => {
              ...
              (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 12px 30px rgba(124,111,205,0.1)";
            }}
            onMouseLeave={e => {
          ...
          >
            <div style={{
              ...
              background: "#4A154B", display: "flex", alignItems: "center",
            ...
            <div>
              <p style={{ margin: "0 0 4px", fontWeight: 700, fontSize: "0.95rem" }}>Slack</p>
          ...
          >
            ...
            <div>
              <p style={{ margin: "0 0 4px", fontWeight: 700, fontSize: "0.95rem" }}>Instagram</p>
